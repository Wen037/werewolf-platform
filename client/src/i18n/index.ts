...
export const zh: Record<string, string> = {
  ...
  'Contact Owner':              '联系场主',
  'No contact information available for this space.': '该场地暂无联系方式。',
  'Leave a message for the owner': '给场主留言',
  'The owner will see your message when they log in.': '场主登录后将看到您的留言。',
  'Your message': '留言内容',
  'Write your message here...': '请输入留言内容…',
  'Send Message': '发送留言',
  'Sending…': '发送中…',
  'Message sent to the owner!': '留言已发送给场主！',
  'You have already sent a message to this owner.': '您已向该场主发送过留言。',
  'Failed to send. Please try again.': '发送失败，请重试。',
  ...
  'Or login with':  '或通过以下方式登录',
  'Or join with':   '或通过以下方式注册',
  'Username (letters, numbers, _)': '用户名（字母、数字、_）',
  'Password (min 8 chars)':         '密码（至少8位）',
  'Send Verification Code':         '发送验证码',
  'A 6-digit code was sent to':     '6位验证码已发送至',
  'Verify & Create Account':        '验证并创建账户',
  'Resend Code':    '重新发送',
  'Verifying…':     '验证中…',
  'Reset Password': '重置密码',
  'Enter your email to receive a 6-digit reset code.': '输入邮箱以接收6位重置码。',
  'Send Reset Code':    '发送重置码',
  '← Back to Login':   '← 返回登录',
  'Enter Reset Code':   '输入重置码',
  'New password (min 8 chars)': '新密码（至少8位）',
  'Resetting…':         '重置中…',
  '← Resend code':      '← 重新发送验证码',
  'Password reset!':    '密码已重置！',
  'Redirecting to login…': '正在跳转到登录页面…',
  ...
  'Enter the 6-digit code.':                 '请输入6位验证码。',
  'Email and password required.':            '请输入邮箱和密码。',
  'This account uses Google Sign-In. Please log in with Google, or set a password using "Forgot Password".':
    '此账户使用Google登录，请用Google登录，或通过"忘记密码"设置密码。',
  'Set a password for this account →': '为此账户设置密码 →',
  'Please enter your email.':               '请输入邮箱。',
  'Enter the 6-digit code from your email.': '请输入邮箱中的6位验证码。',
  'New password must be at least 8 characters.': '新密码至少需要8个字符。',
  ...
  'Spam or misleading':   '垃圾信息或误导',
  'Harassment':           '骚扰',
  'Illegal content':      '违法内容',
  'Additional Details':   '详细说明',
  'Describe the issue...': '请描述问题...',
  'Submitting...':        '提交中…',
  'Submit Report':        '提交举报',
